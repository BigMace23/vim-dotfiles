...
" Set the color theme Use 24-bit (true-color) mode in Vim/Neovim when outside
" tmux.  If you're using tmux version 2.2 or later, you can remove the
" outermost $TMUX check and use tmux's 24-bit color support (see <
